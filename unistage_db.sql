...
VALUES (
        ...
        'L3',
        'https://univ-labe.edu.gn/cv/mamadou_barry.pdf'
    ),
    (
        2,
        3,
        ...
        'L3',
        'https://univ-labe.edu.gn/cv/fatoumata_diallo.pdf'
    ),
    (
        3,
        4,
        ...
        'L2',
        'https://univ-labe.edu.gn/cv/ibrahima_sow.pdf'
    ),
    (
        4,
        5,
        ...
        'Baldé',
        'Aminata',
        'Master Système & Réseaux',
        'M1',
        'https://univ-labe.edu.gn/cv/aminata_balde.pdf'
    ),
    (
        5,
        6,
        ...
        'Licence Informatique',
        'L3',
        'https://univ-labe.edu.gn/cv/ousmane_camara.pdf'
    );
...
VALUES (
    ...
    (
        ...
        'GN-CKY-2015-B-9999',
        'Médias & Télévision',
        'Immeuble Alima, Almamya, Conakry',
        '+224 628 99 88 77',
        'https://canalplus.gn/logo.png',
        TRUE
    ),
    (
        5,
        ...
        'GN-CKY-1999-B-3333',
        'Banque Commerciale',
        'Cité Chemin de Fer, Conakry',
        '+224 625 33 44 55',
        'https://ecobank.gn/logo.png',
        TRUE
    );
...
VALUES (
        1,
        1,
        'Développeur Web Full-Stack (Angular / Spring Boot)',
        'developpeur-web-full-stack-sotelgui-001',
        'Nous recherchons un stagiaire passionné par le développement web moderne pour participer à la refonte de nos applications internes.',
        'Conakry (Kaloum)',
        4,
        1500000.00,
        'PUBLIEE',
    ...
    (
        2,
        2,
        'Technicien Réseau & Infrastructure Télécom',
        'technicien-reseau-orange-002',
        'Stage pratique axé sur l administration des réseaux 4G/5G, la maintenance de la fibre optique et la supervision des équipements.',
        'Labé (Centre)',
        6,
        2000000.00,
        'PUBLIEE',
    ...
    (
        3,
        3,
        'Assistant Analyste Financier & Business Intelligence',
        'assistant-analyste-financier-bcrg-003',
        'Intégrez la Direction Générale des Études et des Statistiques pour modéliser et analyser les indicateurs économiques.',
        'Conakry (BCRG)',
        3,
        1800000.00,
        'PUBLIEE',
    ...
    (
        4,
        4,
        'Chargé de Support Technique & Déploiement Fibre',
        'charge-support-technique-canal-004',
        'Assistance aux abonnés professionnels, paramétrage d équipements et suivi d interventions réseau sur le terrain.',
        'Labé',
        3,
        1200000.00,
        'PUBLIEE',
    ...
    (
        5,
        5,
        'Administrateur Base de Données & Sécurité SI',
        'administrateur-bdd-ecobank-005',
        'Mission centrée sur l optimisation MySQL/Oracle, la gestion des backups et le durcissement des accès de sécurité.',
        'Conakry',
        6,
        2200000.00,
        'EN_ATTENTE_MODERATION',
...
VALUES (
        ...
        1,
        1,
        'Je soussigné Mamadou Barry, étudiant en L3 Informatique à l Université de Labé, sollicite ce stage Full-Stack.',
        'https://univ-labe.edu.gn/cv/mamadou_barry.pdf',
        'RETENUE',
        '2024-08-02 11:30:00'
    ),
    (
        ...
        2,
        2,
        'Étudiante passionnée par les télécoms, je souhaite appliquer mes compétences théoriques au sein d Orange Guinée.',
        'https://univ-labe.edu.gn/cv/fatoumata_diallo.pdf',
        'EN_EXAMEN',
        '2024-08-04 16:20:00'
    ),
    (
        ...
        3,
        3,
        'Fort de mes compétences en algorithmique et statistiques, j apporte ma rigueur à la Banque Centrale.',
        'https://univ-labe.edu.gn/cv/ibrahima_sow.pdf',
        'SOUMISE',
        '2024-08-06 10:00:00'
    ),
    (
        ...
        4,
        4,
        'Spécialiste Réseaux & Systèmes en Master, je postule avec enthousiasme au poste de support technique.',
        'https://univ-labe.edu.gn/cv/aminata_balde.pdf',
        'SOUMISE',
        '2024-08-11 13:10:00'
    ),
    (
        ...
        1,
        2,
        'Candidature secondaire pour le poste de technicien réseau.',
        'https://univ-labe.edu.gn/cv/mamadou_barry.pdf',
        'REFUSEE',
        '2024-08-05 08:45:00'
    );
...
VALUES (
        ...
        '2024-09-02',
        '2024-11-29',
        'Conception et développement de microservices REST Spring Boot et d interfaces utilisateur réactives sous Angular 17.',
        1500000.00,
        'SIGNEE_FINALE',
        '/uploads/conventions/convention_1.pdf',
        '2024-08-08 15:00:00'
    );
...
VALUES (
        ...
        2,
        '🎉 Candidature retenue !',
        'Félicitations ! Votre candidature pour le poste "Développeur Web Full-Stack" chez Sotelgui SA a été retenue. Une convention de stage a été générée.',
        TRUE,
        '2024-08-08 15:05:00'
    ),
    (
        ...
        'Un(e) étudiant(e) vient de postuler à votre offre "Développeur Web Full-Stack". Connectez-vous pour examiner le profil.',
        TRUE,
        '2024-08-02 11:31:00'
    ),
    (
        ...
        'Votre candidature pour le poste Orange Guinée est en cours d examen par l équipe RH.',
        FALSE,
        '2024-08-04 16:25:00'
    ),
    (
        ...
        'La convention de Mamadou Barry (Sotelgui SA) vous a été assignée en tant que tuteur académique.',
        FALSE,
        '2024-08-08 15:10:00'
    );
...
VALUES (
        ...
        'ROLE_ETUDIANT',
        'CREATION_CONVENTION',
        'Convention créée automatiquement suite à la rétention de candidature.',
        '2024-08-08 15:00:00',
        '127.0.0.1'
    ),
    (
        ...
        'Validation des modalités pratiques et indemnité de stage.',
        '2024-08-09 10:30:00',
        '127.0.0.1'
    ),
    (
        ...
        'Validation pédagogique finale et signature de la convention.',
        '2024-08-10 14:00:00',
        '127.0.0.1'
    );
...
VALUES (
        ...
        1,
        1,
        'Rapport de Stage — Refonte Full-Stack chez Sotelgui',
        'Ce rapport détaille l architecture logicielle mise en place durant 3 mois de stage chez Sotelgui SA.',
        '/uploads/rapports/rapport_mamadou_barry.pdf',
        '2024-11-25 17:00:00',
        'VALIDE'
    );
...
VALUES (
        ...
        18,
        18.00,
        'Excellent travail durant tout le déroulement du stage. L étudiant a su faire preuve d une grande autonomie technique.',
        '2024-11-28 11:00:00'
    );
